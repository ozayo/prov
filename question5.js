...
console.log("question5-1: ", addIsFast(car)); // Ska logga { name: "Volvo", speed: 120, isFast: true }
...
console.log("question5-2: ", combineArrays([1, 2, 3], [4, 5, 6])); // Ska logga [1, 2, 3, 4, 5, 6]
